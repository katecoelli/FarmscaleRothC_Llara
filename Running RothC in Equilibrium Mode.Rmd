---
title: "Running RothC in Equilibrium - For Llara"
author: "Kate Coelli"
date: "03/08/2021"
...
kable(LTA_climate, caption ="Long term average climate data for farm midpoint")
```
...
*Note: If the errors of the fractions are too high, check the Sum of the fractions is reaching the measured SOC, if not, the Cinputs may not be high enough to reach equilibrium*
...
write.csv(all_site_fractions_df, "../Processed_Data/fractions_for_initialisation.csv")
```
...
```{r, echo = FALSE}
kable(all_site_fractions_df, caption = "Llara - Fractions to initialise real time model and c inputs used to acquire them")
